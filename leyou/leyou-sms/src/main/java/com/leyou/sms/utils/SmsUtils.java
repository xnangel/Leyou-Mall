...
public class SmsUtils {
    ...
    private static final long SMS_MIN_INTERVAL_IN_MILLIS = 60 * 1000;
    ...
    public SendSmsResponse sendSms(String phoneNumber, String signName, String templateCode, String templateParam) {
        ...
        try {
            ...
            if (!"OK".equals(sendSmsResponse.getCode())) {
                log.error("【短信服务】 发送短信失败，phoneNumber：{}，原因：{}", phoneNumber, sendSmsResponse.getMessage());
            }
